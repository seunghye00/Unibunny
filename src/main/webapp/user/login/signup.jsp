		...
		<div class="signup_container">
			<div class="signupBox">
				...
				<form method="post" action="/signup.member">
					...
					<div class="signup">
						<div class="reg_box">
							<input type="text" placeholder="주민번호 앞6자리" id="input_first" maxlength="6" name="reg_num"> <span>-</span>
							<div class="input_identify2">
								<input type="text" id="input_identify" placeholder="●" maxlength="1" name="reg_num"> <em>●●●●●●</em>
							</div>
